...
alter table `animal_sighting`  add column  `oid`  integer;
...
-- Animal_Sighting_Image [as17]
alter table `image`  add column  `animal_sighting_oid`  integer;


-- Animal_Sighting_Location [as18]
alter table `location`  add column  `animal_sighting_oid`  integer;
...
-- Animal_Species [as3]
alter table `animal`  add column  `species_oid`  integer;
